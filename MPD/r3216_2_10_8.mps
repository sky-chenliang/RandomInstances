...
COLUMNS
    ...
    y#1#10#1  BigM_55              1
    y#1#10#1  valid_1             62
    y#1#10#1  balanc@7            10
    y#1#10#1  balanc@1            62
    y#1#10#2  BigM_56              1
    y#1#10#2  valid_1             62
    y#1#10#2  balanc@8            10
    y#1#10#2  balanc@2            62
    y#1#10#3  BigM_57              1
    y#1#10#3  valid_1             62
    y#1#10#3  balanc@9            10
    y#1#10#3  balanc@3            62
    y#1#10#4  BigM_58              1
    y#1#10#4  valid_1             62
    y#1#10#4  balanc@a            10
    y#1#10#4  balanc@4            62
    y#1#10#5  BigM_59              1
    y#1#10#5  valid_1             62
    y#1#10#5  balanc@b            10
    y#1#10#5  balanc@5            62
    y#1#10#6  BigM_60              1
    y#1#10#6  valid_1             62
    y#1#10#6  balanc@c            10
    y#1#10#6  balanc@6            62
    y#2#1#1   BigM_61              1
    y#2#1#1   valid_3             65
    y#2#1#1   valid_2              7
    y#2#1#1   balan@13            65
    ...
    y#2#10#1  valid_3             10
    y#2#10#1  valid_2             62
    y#2#10#1  balan@13            10
    y#2#10#1  balanc@d            62
    y#2#10#2  BigM_116             1
    y#2#10#2  valid_3             10
    y#2#10#2  valid_2             62
    y#2#10#2  balan@14            10
    y#2#10#2  balanc@e            62
    y#2#10#3  BigM_117             1
    y#2#10#3  valid_3             10
    y#2#10#3  valid_2             62
    y#2#10#3  balan@15            10
    y#2#10#3  balanc@f            62
    y#2#10#4  BigM_118             1
    y#2#10#4  valid_3             10
    y#2#10#4  valid_2             62
    y#2#10#4  balan@16            10
    y#2#10#4  balan@10            62
    y#2#10#5  BigM_119             1
    y#2#10#5  valid_3             10
    y#2#10#5  valid_2             62
    y#2#10#5  balan@17            10
    y#2#10#5  balan@11            62
    y#2#10#6  BigM_120             1
    y#2#10#6  valid_3             10
    y#2#10#6  valid_2             62
    y#2#10#6  balan@18            10
    y#2#10#6  balan@12            62
    y#3#1#1   BigM_121             1
    y#3#1#1   valid_5             65
    y#3#1#1   valid_4              7
    y#3#1#1   balan@1f            65
    ...
    y#3#10#1  valid_5             10
    y#3#10#1  valid_4             62
    y#3#10#1  balan@1f            10
    y#3#10#1  balan@19            62
    y#3#10#2  BigM_176             1
    y#3#10#2  valid_5             10
    y#3#10#2  valid_4             62
    y#3#10#2  balan@20            10
    y#3#10#2  balan@1a            62
    y#3#10#3  BigM_177             1
    y#3#10#3  valid_5             10
    y#3#10#3  valid_4             62
    y#3#10#3  balan@21            10
    y#3#10#3  balan@1b            62
    y#3#10#4  BigM_178             1
    y#3#10#4  valid_5             10
    y#3#10#4  valid_4             62
    y#3#10#4  balan@22            10
    y#3#10#4  balan@1c            62
    y#3#10#5  BigM_179             1
    y#3#10#5  valid_5             10
    y#3#10#5  valid_4             62
    y#3#10#5  balan@23            10
    y#3#10#5  balan@1d            62
    y#3#10#6  BigM_180             1
    y#3#10#6  valid_5             10
    y#3#10#6  valid_4             62
    y#3#10#6  balan@24            10
    y#3#10#6  balan@1e            62
    p#1       BigM_126         -1000
    p#1       BigM_125         -1000
    p#1       BigM_124         -1000
    p#1       BigM_123         -1000
