...
COLUMNS
    ...
    y#2#10#1  valid_2             70
    y#2#10#1  balan@13             2
    y#2#10#1  balanc@d            70
    y#2#10#2  BigM_116             1
    y#2#10#2  valid_3              2
    y#2#10#2  valid_2             70
    y#2#10#2  balan@14             2
    y#2#10#2  balanc@e            70
    y#2#10#3  BigM_117             1
    y#2#10#3  valid_3              2
    y#2#10#3  valid_2             70
    y#2#10#3  balan@15             2
    y#2#10#3  balanc@f            70
    y#2#10#4  BigM_118             1
    y#2#10#4  valid_3              2
    y#2#10#4  valid_2             70
    y#2#10#4  balan@16             2
    y#2#10#4  balan@10            70
    y#2#10#5  BigM_119             1
    y#2#10#5  valid_3              2
    y#2#10#5  valid_2             70
    y#2#10#5  balan@17             2
    y#2#10#5  balan@11            70
    y#2#10#6  BigM_120             1
    y#2#10#6  valid_3              2
    y#2#10#6  valid_2             70
    y#2#10#6  balan@18             2
    y#2#10#6  balan@12            70
    y#3#1#1   BigM_121             1
    y#3#1#1   valid_5             23
    y#3#1#1   valid_4             49
    y#3#1#1   balan@1f            23
    ...
    y#3#10#1  valid_4             70
    y#3#10#1  balan@1f             2
    y#3#10#1  balan@19            70
    y#3#10#2  BigM_176             1
    y#3#10#2  valid_5              2
    y#3#10#2  valid_4             70
    y#3#10#2  balan@20             2
    y#3#10#2  balan@1a            70
    y#3#10#3  BigM_177             1
    y#3#10#3  valid_5              2
    y#3#10#3  valid_4             70
    y#3#10#3  balan@21             2
    y#3#10#3  balan@1b            70
    y#3#10#4  BigM_178             1
    y#3#10#4  valid_5              2
    y#3#10#4  valid_4             70
    y#3#10#4  balan@22             2
    y#3#10#4  balan@1c            70
    y#3#10#5  BigM_179             1
    y#3#10#5  valid_5              2
    y#3#10#5  valid_4             70
    y#3#10#5  balan@23             2
    y#3#10#5  balan@1d            70
    y#3#10#6  BigM_180             1
    y#3#10#6  valid_5              2
    y#3#10#6  valid_4             70
    y#3#10#6  balan@24             2
    y#3#10#6  balan@1e            70
    p#1       BigM_126         -1000
    p#1       BigM_125         -1000
    p#1       BigM_124         -1000
    p#1       BigM_123         -1000
